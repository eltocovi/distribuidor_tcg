...
public class CajaMazo extends Producto{
    ...
    public CajaMazo(int cantidadPorCaja, String edicion, String nombre, String linea, String tipo, int stock, int precio, String sku, String fechaSalida, String descripcion) {
